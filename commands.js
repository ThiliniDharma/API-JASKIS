...
db.bounties.updateMany({}, { $set:
  { captured: true } })
//--------------------------------------------------------------------
  //Bonus: The Scavengers
  //Create a collection called scavengers
 ...
 db.scavengers.insertMany([])
  ...
  db.scavengers.find({ joined: { $gte: IOSDate("2011-12-31T00:00:00Z") }})
  ...
  db.scavengers.find({ wepon: { $exists:false } })